...
let print_env =
  sexp_println (Map.sexp_of_m__t (module String) Ofluxl.Infer.Scheme.sexp_of_t)

let print_kinds =
  sexp_println (Map.sexp_of_m__t (module Ofluxl.Types.Tvar) Ofluxl.Types.Kind.sexp_of_t)
